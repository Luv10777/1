...
.store-info-page{max-width:1180px;margin:0 auto;padding:42px 42px 80px;font-family:'Noto Sans SC',sans-serif}.store-info-header{display:flex;align-items:flex-end;justify-content:space-between;gap:32px;margin-bottom:30px}.store-info-header h1{margin:9px 0 8px;color:#172033;font:800 32px/1.15 Manrope,'Noto Sans SC',sans-serif;letter-spacing:-.03em}.store-info-intro{margin:0;color:#68738b;font-size:13px}.header-meta{display:flex;align-items:center;gap:8px;padding-bottom:5px;color:#8791a5;font-size:11px;white-space:nowrap}.sync-dot{width:7px;height:7px;border-radius:50%;background:#28b981;box-shadow:0 0 0 4px rgba(40,185,129,.12)}.meta-divider{width:1px;height:14px;background:#d9deea}.mono{font-family:'IBM Plex Mono',monospace;font-size:10px;letter-spacing:.04em}.store-info-layout{display:grid;grid-template-columns:215px minmax(0,1fr);gap:28px;align-items:start}.store-info-aside{position:sticky;top:25px}.completion-card{padding:16px;border:1px solid #e2e7f0;border-radius:12px;background:#fff;box-shadow:0 8px 24px rgba(32,52,90,.05)}.completion-top{display:flex;justify-content:space-between;align-items:center}.completion-top strong{color:#c37f6d;font:800 18px Manrope,sans-serif}.completion-track{height:6px;margin:12px 0 9px;border-radius:99px;background:#edf0f7;overflow:hidden}.completion-track span{display:block;height:100%;border-radius:inherit;background:#c98b7a;transition:width .25s ease}.completion-card p{margin:0;color:#8690a3;font-size:11px;line-height:1.55}.anchor-nav{display:grid;gap:3px;margin:20px 0}.anchor-nav a{display:flex;align-items:center;gap:11px;padding:10px 11px;border-radius:8px;color:#7b8498;font-size:12px;transition:.15s}.anchor-nav a:hover{color:#bc6f5a;background:#f8f4f3}.anchor-nav a span{color:#a0a8b8;font:500 10px 'IBM Plex Mono',monospace}.aside-note{display:flex;gap:9px;padding:13px 11px;border:1px solid #dfe4f0;border-radius:10px;background:#f9f5f4;color:#bd725e}.aside-note .material-symbols-outlined{font-size:18px}.aside-note strong{font-size:11px}.aside-note p{margin:4px 0 0;color:#a48077;font-size:10px;line-height:1.5}.store-form{display:grid;gap:16px}.form-card{padding:25px 28px 28px;border:1px solid #e1e6ef;border-radius:14px;background:#fff;box-shadow:0 8px 28px rgba(32,52,90,.045)}.card-heading{display:flex;align-items:center;justify-content:space-between;margin-bottom:24px}.card-heading>div{display:flex;align-items:center;gap:12px}.step-number{display:grid;place-items:center;width:29px;height:29px;border-radius:8px;background:#f9f6f5;color:#c4806d;font:700 11px 'IBM Plex Mono',monospace}.card-heading h2{margin:4px 0 0;color:#1c2639;font:700 18px/1.2 'Noto Sans SC',sans-serif}.card-caption{color:#a0a8b8;font-size:11px}.field-grid{display:grid;gap:18px}.two-col{grid-template-columns:1fr 1fr}.field{display:grid;gap:8px;margin-bottom:18px;border:0;padding:0}.field:last-child{margin-bottom:0}.field-label{display:flex;align-items:center;gap:6px;color:#313b4f;font-size:12px;font-weight:600}.field-label b{color:#e34f6f;font-weight:700}.field-label em{color:#a4acba;font-size:10px;font-style:normal;font-weight:400}.field input,.field select,.field textarea{width:100%;padding:11px 12px;border:1px solid #dfe4ed;border-radius:8px;outline:none;background:#fff;color:#202b40;font-size:12px;transition:border-color .15s,box-shadow .15s}.field input::placeholder,.field textarea::placeholder{color:#aab2c1}.field textarea{resize:vertical;line-height:1.6}.field input:focus,.field select:focus,.field textarea:focus{border-color:#d19c8d;box-shadow:0 0 0 3px rgba(199,161,151,.11)}.field input.invalid,.field select.invalid{border-color:#e26a7d}.field-error{color:#d5536a;font-size:10px}.status-field{margin-top:22px}.status-options{display:grid;grid-template-columns:repeat(4,1fr);gap:9px}.status-option{display:flex;align-items:center;gap:7px;padding:10px 11px;border:1px solid #e2e6ee;border-radius:8px;color:#667187;font-size:11px;cursor:pointer;transition:.15s}.status-option input{position:absolute;opacity:0}.status-check{width:8px;height:8px;border-radius:50%;background:#aab2c1}.status-option.selected{border-color:currentColor;background:#fdfcfc}.status-option.selected .status-check{box-shadow:0 0 0 3px currentColor}.tone-green{color:#239b6e}.tone-amber{color:#c58629}.tone-orange{color:#d46b38}.tone-slate{color:#78849a}.region-grid{display:grid;grid-template-columns:1fr 1fr 1fr;gap:9px}.region-grid select{appearance:auto}.hours-row{display:flex;align-items:center;gap:10px}.hours-row input{max-width:150px}.hours-row>span{color:#8c96a8;font-size:12px}.hours-hint{margin-left:4px;color:#a6afbd!important;font-size:10px!important}.amenity-list{display:flex;flex-wrap:wrap;gap:8px}.amenity-chip{display:inline-flex;align-items:center;gap:6px;padding:9px 11px;border:1px solid #e1e6ee;border-radius:8px;color:#68748a;font-size:11px;cursor:pointer;transition:.15s}.amenity-chip input{position:absolute;opacity:0;width:1px}.amenity-chip.selected{border-color:#d6a699;background:#f9f6f6;color:#c07764}.chip-check{display:grid;place-items:center;width:14px;height:14px;border:1px solid #cad1df;border-radius:4px;color:transparent;font-size:9px}.selected .chip-check{border-color:#d19c8e;background:#d19c8e;color:#fff}.field-label-row{display:flex;align-items:center;justify-content:space-between}.text-button{border:0;background:none;color:#c68675;font-size:11px;cursor:pointer}.upload-drop{position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:184px;border:1px dashed #b9c1d2;border-radius:10px;background:#fdfcfb;color:#79849a;text-align:center;cursor:pointer;transition:.15s;overflow:hidden}.upload-drop:hover,.upload-drop.dragging{border-color:#d19c8d;background:#fbf9f9}.upload-drop.filled{border-style:solid;border-color:#dfe4ed;padding:0}.upload-drop img{width:100%;height:100%;min-height:184px;object-fit:cover}.upload-icon{margin-bottom:8px;color:#cf9889;font-size:27px}.upload-drop strong{color:#4b566d;font-size:12px}.upload-drop small{margin-top:6px;color:#9aa4b5;font-size:10px}.upload-drop .upload-limit{margin-top:12px;color:#b2bac8;font-family:'IBM Plex Mono',monospace;font-size:9px}.environment-field{margin-top:22px}.environment-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:9px}.environment-photo,.environment-add{position:relative;aspect-ratio:1;border-radius:8px;overflow:hidden}.environment-photo{padding:0;border:1px solid #e0e5ee;background:#f9f6f6;cursor:pointer}.environment-photo img{width:100%;height:100%;object-fit:cover}.environment-photo span{position:absolute;inset:auto 0 0;padding:5px;background:rgba(20,27,42,.72);color:#fff;font-size:10px;opacity:0;transition:.15s}.environment-photo:hover span{opacity:1}.environment-add{display:grid;place-items:center;align-content:center;gap:4px;border:1px dashed #c2cada;background:#fdfcfb;color:#969faf;cursor:pointer}.environment-add span{color:#d09a8c;font-size:21px}.environment-add small{font-size:10px}.form-footer{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:8px 2px}.form-notice{display:flex;align-items:center;gap:7px;margin:0;color:#d05a6b;font-size:11px}.form-notice.success{color:#258d69}.form-notice .material-symbols-outlined{font-size:17px}.form-actions{display:flex;align-items:center;gap:10px}.ghost-button,.primary-button{padding:11px 17px;border-radius:8px;font-size:12px;cursor:pointer}.ghost-button{border:1px solid #dce2ec;background:#fff;color:#6b768a}.ghost-button:hover{background:#fbf9f9}.primary-button{border:1px solid #c37f6d;background:#c37f6d;color:#fff;box-shadow:0 5px 12px rgba(183,134,121,.2)}.primary-button:hover{background:#ba6b56}.primary-button span{margin-left:8px;font-size:15px}.eyebrow{margin:0;color:#9aa3b5;font:500 9px/1.3 'IBM Plex Mono',monospace;letter-spacing:.14em}.eyebrow.accent{color:#cb8e7e}
...
/* Sea-glass palette: a calmer alternative to the previous cinnabar treatment */
...
.completion-top{align-items:flex-start}.completion-top strong{display:block;margin-top:5px;color:#303a4e;font-size:13px}.completion-top>b{color:#c37f6d;font:800 22px Manrope,sans-serif}.completion-track{height:7px;margin:16px 0 11px}.completion-foot{display:flex;justify-content:space-between;align-items:center;color:#8690a3;font-size:10px}.completion-state{display:flex;align-items:center;gap:5px;color:#a07569;font-family:'IBM Plex Mono',monospace;font-size:9px}.completion-state i{width:6px;height:6px;border-radius:50%;background:#c98b7a}
.anchor-nav{gap:2px;margin:26px 0}.anchor-nav>.eyebrow{padding:0 12px;margin-bottom:7px}.anchor-nav a{position:relative;gap:13px;padding:11px 12px;border-radius:9px}.anchor-nav a i{position:absolute;left:-1px;width:3px;height:18px;border-radius:0 3px 3px 0;background:#cb8e7e;opacity:0;transform:scaleY(.5);transition:.18s}.anchor-nav a.active{color:#303a4e;background:#faf7f6}.anchor-nav a.active strong{font-weight:700}.anchor-nav a.active i{opacity:1;transform:scaleY(1)}.anchor-nav a.active span{color:#cb8e7e}
...
/* Final theme pass: remove every remaining cinnabar accent */
